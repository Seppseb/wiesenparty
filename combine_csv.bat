...
echo Vorname,Nachname,Email,Handynummer,Stadt,Straße,Hausnummer,Geburtsdatum,Wunschlied,Lieblingsgetränk,Schlafen auf dem Campingplatz,Bezahlt > "%combined_csv_file%"
